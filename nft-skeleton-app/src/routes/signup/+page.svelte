...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input
                            ...
                            type="text"
                            required
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-white-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 {usernameError !=
                            ''
                                ? 'input-error'
                                : ''}"
                        />
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input
                            ...
                            autocomplete="email"
                            required
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-white-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 {emailError !=
                            ''
                                ? 'input-error'
                                : ''}"
                        />
    ...
    {:else}
        <div class="w-full text-token grid grid-cols-1 gap-4">
            <header>
                <img
                    src={getImageLink({
                        id: "vjUokUWbFOs",
            ...
            <div class="p-4 space-y-4">
                <h6 class="h6" data-toc-ignore>Thanks for signing up!</h6>
                <h3 class="h3" data-toc-ignore>Check your email!</h3>
                <article>
                    <p>
                        <!-- cspell:disable -->
