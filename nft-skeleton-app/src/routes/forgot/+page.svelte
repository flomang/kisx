            ...
            <div>
                ...
                <div class="mt-2">
                    <input
                        ...
                        autocomplete="email"
                        required
                        class="block w-full rounded-md border-0 py-1.5 text-white-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                </div>
                <div class="mt-2 block text-sm font-medium leading-6 text-white-900">
                    Enter your email address you registered with and we will
